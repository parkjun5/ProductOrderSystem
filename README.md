...
### 1부
      10:30 → 10:50 효율적으로 성장하기 (부제: 자동차 정비사 개발자 되다)
      11:00 → 11:20 깊게 파고들어야 한다고요? 왜요?
      11:30 → 11:50 자바 퀴즈로 함께 자라기
      12:00 → 12:20 CDC? 네가 뭘 할 수 있는데?
### 2부 
      02:00 → 02:50 이 UI 깨지는데요? 테스트가 나보다 먼저 QA 하게 하기(feat. Playwright)
      03:00 → 03:50 주니어 개발자의 플러팅 기술 - 칭찬편
### 3부
      04:30 → 05:20 Kotlin으로 맞춤형 MongoDB DSL 개발하기
      05:30 → 06:20 함께 해봐요. Spring Event Internal
