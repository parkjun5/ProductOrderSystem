package kr.co.system.homework.legacy.order.v2.application;
...
public class OrderV2Service {
    ...
    public OrderV2Service(ProductV2Service productService, OrderV2Repository orderRepository) {
    ...
    public OrderResponse createOrderOf(Cart cart) {
        ...
        for (CartItem cartItem : cart.getCartItems()) {
            ProductV2 product = productService.getProductWithLockBy(cartItem.getProductId());
            orderItems.add(OrderItemV2.of(product, cartItem.getQuantity(), product.getProductInfo()));
        }
